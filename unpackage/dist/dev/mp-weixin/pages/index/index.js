...
var _hot_super_hero = _interopRequireDefault(__webpack_require__(/*! ../../static/json/hot_super_hero.json */ 18));
var _hot_trailer = _interopRequireDefault(__webpack_require__(/*! ../../static/json/hot_trailer.json */ 19));
var _guess_you_like = _interopRequireDefault(__webpack_require__(/*! ../../static/json/guess_you_like.json */ 20));var _this2 = void 0;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var stars = function stars() {return __webpack_require__.e(/*! import() | components/stars */ "components/stars").then(__webpack_require__.bind(null, /*! ../../components/stars.vue */ 35));};
...
var _default = {
  ...
  onLoad: function onLoad() {var _this = this;
    ...
    uni.request({
      ...
      success: function success(res) {
        if (res.statusCode == 200) {
          res.data = _carousel_list.default;
    ...
    uni.request({
      ...
      complete: function complete() {
        _this.hotSuperheroList = _hot_super_hero.default.data;
      } });
    ...
    uni.request({
      ...
      complete: function complete() {
        _this.hotTrailerList = _hot_trailer.default.data;
        _this.guessYouLikeList = _guess_you_like.default.data;
  ...
  onUnload: function onUnload() {
    _this2.animationData = {};
    _this2.animationDataArr = [{}, {}, {}, {}, {}];
  },
  ...
  components: {
    stars: stars } };exports.default = _default;
